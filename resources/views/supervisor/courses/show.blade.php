...
<div id="div-indent">
    ...
    @foreach ($course->subjects as $subject)
        <h1>
            <span class="label label-default">{!! link_to_route('supervisor.subjects.show', $subject->name, [$subject->id]) !!}</span>
        </h1>
        @if ($subject->pivot->is_finished == 0)
            {!! Form::open(['route' => ['supervisor.subjects.update', $subject->id], 'method' => 'PUT']) !!}
